  ...
  const renderItem = (item) => {
    if (item.user) {
      return (
        <View style={styles.userContent}>
          ...
          />
          <View style={{ paddingHorizontal: 8, paddingRight: 40 }}>
            <View
              style={[
    ...
    return (
      <View style={styles.meContent}>
        <View style={{ paddingLeft: 8, paddingLeft: 80 }}>
          <View
            style={[
    ...
    <SafeAreaView style={BaseStyle.safeAreaView} forceInset={{ top: "always" }}>
      ...
      >
        ...
        <View style={styles.inputContent}>
          <View style={{ flex: 1, }}>
            <TextInput
              style={{ borderRadius: 40, paddingHorizontal: 20, backgroundColor: "#EEECEC" }}
          ...
          <TouchableOpacity
            style={[styles.sendIcon, { backgroundColor: "#0191CB" }]}
            onPress={sendMessage}
          >
            <Icon
              solid
